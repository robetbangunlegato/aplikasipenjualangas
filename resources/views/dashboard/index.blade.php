<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    <x-navbars.sidebar activePage='dashboard.index'></x-navbars.sidebar>
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        ...
                        <div class="card-footer p-3 text-end">
                            <p class="mb-0 text-center">Jumlah barang saat ini</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        ...
                        <div class="card-footer p-3">
                            <p class="mb-0 text-center">Jumlah pengguna
                                aplikasi saat ini</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                ...
                                <h4 class="mb-0">{{ $jumlah_produk }}</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0 text-center">Jumlah produk saat ini</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                ...
                                <h4 class="mb-0">Rp.{{ $total_penjualan }}</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0 text-center">Total penjualan</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card z-index-2 ">
                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                <div class="chart">
                                    <canvas id="chart-jumlah-barang" class="chart-canvas" height="170"></canvas>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <h6 class="mb-0 ">Jumlah barang</h6>
                            <p class="text-sm ">Jumlah barang yang tersedia</p>
                            <hr class="dark horizontal">
                            <div class="d-flex ">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
                                <p class="mb-0 text-sm"> terakhir diperbaharui pada <strong>
                                        {{ $waktu_terbaru_baris_data_tabel_barangs_diupdate }} </strong></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @push('js')
        ...
        <script>
            //chart jumlah barang
            var ctx = document.getElementById("chart-jumlah-barang").getContext("2d");

            new Chart(ctx, {
                type: "bar",
                data: {
                    labels: {!! $sumbu_x_diagram_batang !!},
                    datasets: [{
                        label: "Jumlah barang",
                        tension: 0.4,
                        borderWidth: 0,
