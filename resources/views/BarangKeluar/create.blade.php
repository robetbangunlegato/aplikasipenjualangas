<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    <x-navbars.sidebar activePage='barangkeluar.create'></x-navbars.sidebar>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="input-group input-group-outline is-filled">
                            ...
                            <input type="text" class="form-control" disabled value="Keluar">
                            <input type="text" name="jenis_transaksi" hidden value="Keluar">
                        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="input-group input-group-outline">
                            <label for="" class="form-label">Jumlah barang keluar</label>
                            <input type="number" name="jumlah" class="form-control" min="1">
                        </div>
                        @error('jumlah')
                            <div class="alert alert-danger py-0 mt-0 text-white">{{ $message }}
                            </div>
                        @enderror
                    </div>
                    <div class="col-6">
